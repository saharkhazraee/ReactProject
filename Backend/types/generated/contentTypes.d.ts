...
export interface ApiAboutSliderAboutSlider extends Schema.CollectionType {
  collectionName: 'about_sliders';
  info: {
    singularName: 'about-slider';
    pluralName: 'about-sliders';
...
export interface ApiCasualStyleCasualStyle extends Schema.CollectionType {
  collectionName: 'casual_styles';
  info: {
    singularName: 'casual-style';
    pluralName: 'casual-styles';
...
export interface ApiCategoryCategory extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    image: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    women: Attribute.Relation<
      'api::category.category',
      'manyToMany',
      'api::woman.woman'
    >;
    men: Attribute.Relation<
      'api::category.category',
      'manyToMany',
      'api::man.man'
    >;
...
export interface ApiHomeImageHomeImage extends Schema.CollectionType {
  collectionName: 'home_images';
  info: {
    singularName: 'home-image';
    pluralName: 'home-images';
    displayName: 'homeImage';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::about-slider.about-slider': ApiAboutSliderAboutSlider;
      'api::auth.auth': ApiAuthAuth;
      'api::casual-style.casual-style': ApiCasualStyleCasualStyle;
