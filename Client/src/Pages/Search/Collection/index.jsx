...
export default function Collection() {
    ...
    return (
        <Stack justifyContent={'center'} alignItems={'center'} gap={'20px'} sx={{margin:'4% 0',marginTop:'8%',width:'100%'}}>
            <Typography variant='h3' component={'h1'} sx={{fontFamily:'asns'}}>
                <Typography variant='h3' component={'span'} sx={{color:"#8B4513",fontFamily:'asns'}}>OUR  </Typography>
                 COLLECTION
            </Typography>
            <Stack direction={'row'} justifyContent={'center'} alignItems={'center'} gap={'40px'} flexWrap={'wrap'}
                sx={{ padding: '20px 2%', width: "100%", height: '500px' }}>
                {items}
            </Stack>
        </Stack>
    )
